import product1 from '../../assets/Abdurahman/svg/photo.svg'
import go from '../../assets/IMGS/svg/goto.svg'
export default function BedProduct1() {
    return(
        <>
            <div className='lg:flex gap-[30px] items-center sm:flex-row justify-center  '>
               <img className='lg:w-[456px] md:w-[350px] sm:w-[300px]  h-[275px] order-2' src={product1} alt="img" /> 
                <div className='ml-[50px] flex items-center flex-col gap-2 '>
                    ...
                    <div className='flex items-center justify-center rounded-full  sm:w-2 lg:w-9 lg:h-9 p-1 border border-blue-700'>
                        <img className='lg:w-3 lg:h-3 order-1' src={go} alt="img" />
                    </div>
                </div>
