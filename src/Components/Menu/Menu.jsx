...
function Menu() {
    return (
        <>
            ...
            {/* <div className='flex'>
                <img className='lg:w-[360px] lg:h-[321px] md:w-[280px] md:h-[277px] sm:w-[160px] sm:h-[157px] xs:w-[150px] xs:h-[147px]' src={product2} alt="img" />
                <div className='lg:w-[360px] lg:h-[321px] md:w-[280px] md:h-[277px] sm:w-[160px] sm:h-[157px] xs:w-[150px] xs:h-[147px]   items-center flex flex-col gap-2'>
                    <h1 className='text-custom font-gilroy text-24 font-bold leading-custom tracking-tighter text-left uppercase'>Гостиные</h1><br />
                    <p className="text-custom font-inter text-16 font-normal leading-custom tracking-tighter text-left">Мини текст описания и преимущества<br />
                        покупки данного направления.</p>
                    <a className='text-custom font-inter text-16 font-normal leading-custom tracking-tighter text-left text-blue-800'>Товары под заказ в наличии: 2030шт</a><br />
            ...
            <div className='flex'>
                <div className=' lg:w-[360px] lg:h-[321px] md:w-[280px] md:h-[277px] sm:w-[160px] sm:h-[157px] xs:w-[150px] xs:h-[147px]  flex items-center flex-col gap-2'>
                    <h1 className='text-custom font-gilroy text-24 font-bold leading-custom tracking-tighter text-left uppercase'>Гостиные</h1><br />
                    <p className="text-custom font-inter text-16 font-normal leading-custom tracking-tighter text-left">Мини текст описания и преимущества<br />
                        покупки данного направления.</p>
                    <a className='text-custom font-inter text-16 font-normal leading-custom tracking-tighter text-left text-blue-800'>Товары под заказ в наличии: 2030шт</a><br />
                ...
                <img className='lg:w-[360px] lg:h-[321px] md:w-[280px] md:h-[277px] sm:w-[160px] sm:h-[157px] xs:w-[150px] xs:h-[147px]' src={product3} alt="img" />
            </div>
            <div className='flex'>
                <div className=' lg:w-[360px] lg:h-[321px] md:w-[280px] md:h-[277px] sm:w-[160px] sm:h-[157px] xs:w-[150px] xs:h-[147px]  flex items-center flex-col gap-2 '>
                    <h1 className='text-custom font-gilroy text-24 font-bold leading-custom tracking-tighter text-left uppercase'>Гостиные</h1><br />
                ...
                <img className='lg:w-[360px] lg:h-[321px] md:w-[280px] md:h-[277px] sm:w-[160px] sm:h-[157px] xs:w-[150px] xs:h-[147px]' src={product4} alt="img" />
            </div>
            <div className='flex'>
                <img className='lg:w-[900px] lg:h-[321px] md:w-[280px] md:h-[277px] sm:w-[160px] sm:h-[157px] xs:w-[150px] xs:h-[147px]' src={product5} alt="img" />
                <div className='lg:w-[360px] lg:h-[321px] md:w-[280px] md:h-[277px] sm:w-[160px] sm:h-[157px] xs:w-[150px] xs:h-[147px]  flex justify-center flex-col gap-2 p-2 mt-10'>
